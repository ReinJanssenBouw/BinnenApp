...
Via **2D-plattegrond** zie je dezelfde ruimte en stellingen op schaal van bovenaf. Klik op een stelling om de instellingen rechts te openen. Als beheerder kun je een stelling met de muis naar een andere plek slepen. Binnen 10 cm van een muur klikt de rand van de stelling automatisch tegen de binnenkant van de muur. Een groene lijn toont de muur; in een hoek kunnen twee muren tegelijk vastklikken. Trek verder dan 18 cm van de muur om los te komen. De ingestelde draaihoek en afmetingen blijven behouden. De plattegrond blijft tijdens het slepen op dezelfde schaal, ook als je ingezoomd bent. Druk tijdens het slepen op **Esc** om de verplaatsing te annuleren. Klik op **Model opslaan** om de nieuwe positie te bewaren; 2D en 3D gebruiken dezelfde positie. De dikke blauwe rand markeert de voorkant. Met + en − zoom je; **Alles in beeld** herstelt het overzicht. Wijzigingen blijven behouden als je terugschakelt naar **3D**.
