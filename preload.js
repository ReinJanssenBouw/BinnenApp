...
const leesActies = new Set(['getLocationScene', 'getLocationLayout', 'getStock', 'getCart', 'getOrders', 'getProductsAdmin', 'getRetour', 'getCorrections', 'getStatusDatums', 'orderConfirmationPdf', 'orderMailStatus']);
